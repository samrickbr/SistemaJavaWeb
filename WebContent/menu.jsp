		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="salvarUsuario?acao=listartodos" class="smoothScroll">Cadastrar
							Usuário</a></li>
					<li><a href="salvarUsuario?acao=consultartodos" class="smoothScroll">Consultar Usuário</a></li>
					<li><a href="salvarProduto?acao=consultartodos" class="smoothScroll">Cadastro de Produto</a></li>
